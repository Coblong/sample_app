...
module RobotsHelper
  ...
  def write_setfile
    ...
    #Acc.Target.Bal=1120000; 
    #Acc.Stop.Bal=0; 
    #_inp2.5_=" --- DRAWDOWWN LIMITER --- "; 
    #Drawdown.Limiter.On=false; 
    #Drd.Lim.Mode=""; 
    #Drd.Lim.Period=0; 
    #_inp3_=" --- ENTRY CRITERIA --- "; 
    #Entry_Envelopes=0.044; 
    #Envelope_Period=9; 
    #MA_Type=1; 
    #Envelope_Source=4; 
    #Max_Spread=2.8; 
    #Reset_Envelopes=0.11; 
    #_inp4_=" --- STOP LOSS CRITERIA ---"; 
    #Fixed_Range_Stop_On=true; 
    #Fixed_Range_Stop_Ratio=2.4; 
    #Dynamic_Stop_Envelopes=0; 
    #Stop_Loss_Pips=0; 
    #Trailing_Stop=0; 
    #_inp5_=" --- TARGET CRITERIA ---"; 
    #Take_Profit_Pips=0; 
    #Target_Envelopes=0.047; 
    #Max_Trade_Duration=0; 
    #_inp6_=" --- TREND FILTERS ---"; 
    #EMA_Trend_Filter=false; 
    #EMA_Trend_Fast_Per=0; 
    #EMA_Trend_Slow_Per=0; 
    #EMA2_Trend_Filter=false; 
    #EMA2_Trend_TF=0; 
    #EMA2_Trend_Fast_Per=0; 
    #EMA2_Trend_Slow_Per=0; 
    #EMA3_Trend_Filter=false;#
    #EMA3_Trend_TF=0; 
    #EMA3_Trend_Fast_Per=0; 
    #EMA3_Trend_Slow_Per=0; 
    #EMA4_Trend_Filter=false; 
    #EMA4_Trend_TF=0; 
    #EMA4_Trend_Fast_Per=0; 
    #EMA4_Trend_Slow_Per=0; 
    #_inp7_=" --- CONSOLIDATION FILTER ---"; 
    #BBands.TF=0; 
    #BBands.Period=20; 
    #BBands.Deviation=1; 
    #BBands.AppliedPrice=0; 
    #BBands.Narrowing=true; 
    #BBands.CheckMaxPips=true; 
    #BBands.MaxPips=40; 
    ...
    #Friday.On=0; 
    #Saturday.On=0; 
    #Mon.FirstEntryHour.ON=0; 
    #Mon.FirstEntryHour_GMT=0; 
    #Mon.MorningExitHour.ON=0; 
    #Mon.MorningExitHour_GMT=0; 
    #Tue.MorningExitHour.ON=0; 
    #Tue.MorningExitHour_GMT=0; 
    #Wed.MorningExitHour.ON=0; 
    #Wed.MorningExitHour_GMT=0; 
    #Thu.MorningExitHour.ON=0; 
    #Thu.MorningExitHour_GMT=0; 
    #Fri.MorningExitHour.ON=1; 
    #Fri.MorningExitHour_GMT=21; 
    #Friday.ExitTradesHour_GMT=21; 
    #Friday.LastEntryHour_GMT=20; 
    ...
    #Lbl.OK.Clr=Lime; 
    #Lbl.NOT.OK.Clr=Red; 
    #Lbl.Uptrend.Clr=Aqua; 
    #Lbl.Downtrend.Clr=Magenta; 
    #_inp11_=" --- ARROWS SETTINGS---"; 
    #Long.Entry.Clr=DodgerBlue; 
    #Long.Profit.Clr=DodgerBlue; 
    #Long.Loss.Clr=DarkViolet; 
    #Long.Stop.Clr=Red; 
    #Short.Entry.Clr=Gold; 
    #Short.Profit.Clr=Gold; 
    #Short.Loss.Clr=DarkViolet; 
    #Short.Stop.Clr=Red; 
    #Trailing.SL.Clr=Silver;
  end
end
